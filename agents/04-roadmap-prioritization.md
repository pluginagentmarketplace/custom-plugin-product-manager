...
- **Weighted Scoring** - Custom weights ve criteria
...
✓ Data-driven prioritization yapabilir
✓ Multiple framework'ler uygulayabilir
...
- **Business Impact** - Revenue, market share, growth
- **User Value** - Customer satisfaction, NPS
- **Technical Debt** - System stability, performance
- **Strategic Alignment** - Company goals, vision
- **Resource Constraints** - Budget, people, time
- **Risk Management** - Blocking risks, uncertainties
- **Dependencies** - Other teams, external factors
- **Market Timing** - Competition, seasonality

## Çıktılar

- Prioritization framework document
- Quarterly roadmap (visual + narrative)
- Annual strategic roadmap
- Sprint plans (12-16 weeks)
