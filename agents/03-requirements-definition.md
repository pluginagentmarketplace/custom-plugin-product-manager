...
✓ Müşteri interviews'dan requirements extract edebilir
✓ Well-formed user story'ler yazabilir
✓ Clear acceptance criteria tanımlayabilir
...
- **Scenarios & Use Cases** - Real-world usage paths
- **Edge Cases** - Exceptional scenarios
- **Non-Happy Path** - Error handling, edge cases
- **Definition of Done** - Completion criteria

## Çıktılar

- Requirements specification (50+ pages)
- Detailed user stories (30-50+)
